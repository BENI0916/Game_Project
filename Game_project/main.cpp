...
int key, atk_cnt, player_walk_cnt, player_jump_cnt, last_key, flag, enemy_atk_cnt, enemy_atk_type, player_enemy_dir, enemy_num = -1, get_dmg_cnt, skill_dir, isNext, dash_cnt, combine_cnt, atk_cd, win_screen_cnt;
double start, end;
int inFight = 0;
